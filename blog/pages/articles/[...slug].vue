...
const articleData = {
  'first-article': {
    title: '我的第一篇文章',
    description: '这是我的第一篇博客文章，记录了我开始写博客的想法和计划。',
    date: '2024-01-15',
    author: '博主',
    tags: ['生活', '随想'],
    body: {
      ...
      children: [
        {
          type: 'element',
          tag: 'h2',
          children: [{ type: 'text', value: '开始写博客' }]
        },
        {
          type: 'element', 
          tag: 'p',
          children: [{ type: 'text', value: '今天我决定开始写博客，记录我的学习和生活。' }]
        },
        {
          type: 'element',
          tag: 'h2', 
          children: [{ type: 'text', value: '为什么写博客' }]
        },
        {
          type: 'element',
          tag: 'ul',
          children: [
            {
              type: 'element',
              tag: 'li',
              children: [{ type: 'text', value: '记录学习过程' }]
            },
            {
              type: 'element',
              tag: 'li', 
              children: [{ type: 'text', value: '分享经验和想法' }]
            },
            {
              type: 'element',
              tag: 'li',
              children: [{ type: 'text', value: '提高写作能力' }]
            }
          ]
        }
      ]
  ...
  'second-article': {
    ...
    description: '深入了解Vue 3的组合式API，包括setup函数、响应式系统等核心概念。',
    date: '2024-01-20',
    author: '博主',
    tags: ['Vue', '前端', '技术'],
    body: {
      ...
      children: [
        {
          type: 'element',
          tag: 'h2',
          children: [{ type: 'text', value: '什么是组合式API' }]
        },
        {
          type: 'element',
          tag: 'p', 
          children: [{ type: 'text', value: 'Vue 3引入了组合式API，提供了更灵活的代码组织方式。' }]
        },
        {
          type: 'element',
          tag: 'h2',
          children: [{ type: 'text', value: 'setup函数' }]
        },
        {
          type: 'element',
          tag: 'p',
          children: [{ type: 'text', value: 'setup函数是组合式API的入口点，在组件创建之前执行。' }]
        }
      ]
    }
  }
